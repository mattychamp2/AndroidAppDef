...
public class CreateAccount extends AppCompatActivity {
    ...
    private TextView firstName, lastName, username, password, passwordRepeat;
    private RequestQueue requestQueue;
    private String postUrl, checkUnUrl;
    ...
    public void existingUsername(View v) {
        ...
        JsonArrayRequest submitRequest = new JsonArrayRequest(Request.Method.GET, checkUnUrl, null,
                ...
                error -> Toast.makeText(CreateAccount.this, "Server error, try again later", Toast.LENGTH_SHORT).show()
        );
    ...
    public boolean checkRequirements(View v) {
        ...
        if (!(givenPw.equals(givenPwRp))) {
            ...
            if (givenPw.length() < 7) {
                Toast.makeText(CreateAccount.this, "Password must be at least 7 characters long", Toast.LENGTH_SHORT).show();
                check = false;
            }
    ...
    public void createAccount(View v) {
        ...
        JsonArrayRequest submitRequest = new JsonArrayRequest(Request.Method.GET, getInfo(), null,
                ...
                error -> Toast.makeText(CreateAccount.this, "Could not create account, try again later", Toast.LENGTH_SHORT).show()
        );
        requestQueue.add(submitRequest);
    }
